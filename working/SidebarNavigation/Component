...
import { FolderOpenIcon, UsersIcon, ChatBubbleLeftRightIcon, QuestionMarkCircleIcon } from "@heroicons/react/24/outline";
...
export default function SidebarNavigation_Component() {
  ...
  return (
    <nav className="bg-gray-100 h-screen w-64 fixed left-0 top-0 transition-all duration-300 ease-in-out lg:translate-x-0 overflow-y-auto"
